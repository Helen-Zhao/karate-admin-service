 ...
 * AuditorPU.PersistenceManager is instantiated, it creates an EntityManagerFactory. When
...
public class PersistenceManager {
	...
	protected PersistenceManager() {
		_entityManagerFactory = Persistence.createEntityManagerFactory("MemberPU");
	}
